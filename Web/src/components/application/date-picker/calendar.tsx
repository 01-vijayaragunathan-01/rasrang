                ...
                {({ state }) => (
                    <>
                        <header className="flex items-center justify-between px-2">
                            <Button slot="previous" iconLeading={ChevronLeft} size="sm" color="tertiary" className="size-8 text-white/50 hover:text-white hover:bg-white/10 border-none" />
                            <AriaHeading className="text-sm font-bold text-white tracking-widest uppercase" />
                            <Button slot="next" iconLeading={ChevronRight} size="sm" color="tertiary" className="size-8 text-white/50 hover:text-white hover:bg-white/10 border-none" />
                        </header>
                            ...
                            <AriaCalendarGridHeader className="border-b-4 border-transparent">
                                {(day) => (
                                    <AriaCalendarHeaderCell className="p-0">
                                        <div className="flex size-10 items-center justify-center text-[10px] font-bold uppercase tracking-widest text-zinc-500">{day.slice(0, 2)}</div>
