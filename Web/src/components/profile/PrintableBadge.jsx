        ...
        >
            ...
            <div style={{
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                        ...
                        <div>
                            <p style={{ margin: 0, color: "#22D3EE", fontSize: "14px", letterSpacing: "5px", fontFamily: "monospace", fontWeight: 700 }}>
                                RASRANG 2K26
                            </p>
                            <p style={{ margin: "2px 0 0", color: "rgba(34,211,238,0.6)", fontSize: "9px", letterSpacing: "4px", fontFamily: "monospace" }}>
                                ANNUAL CULTURAL FESTIVAL
                            </p>
                        </div>
                    </div>
                    <div style={{ border: "1px solid rgba(34,211,238,0.4)", padding: "5px 14px", color: "rgba(34,211,238,0.7)", fontSize: "10px", letterSpacing: "3px", fontFamily: "monospace" }}>
                        FESTIVAL EVENT PASS
                    </div>
                </div>
                ...
                {/* Name + reg */}
                <div>
                    <p style={{ margin: "0 0 2px", color: "rgba(255,255,255,0.3)", fontSize: "10px", letterSpacing: "5px", fontFamily: "monospace" }}>BEARER</p>
                    <p style={{ margin: "0 0 5px", color: "#FFFFFF", fontSize: "28px", letterSpacing: "3px" }}>
                        {(user?.name || "GUEST ATTENDEE").toUpperCase()}
                    </p>
                    <p style={{ margin: 0, color: "rgba(255,255,255,0.4)", fontSize: "11px", letterSpacing: "2px", fontFamily: "monospace" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", borderTop: "1px solid rgba(34,211,238,0.15)", paddingTop: "14px" }}>
                    <div>
                        <p style={{ margin: "0 0 2px", color: "rgba(255,255,255,0.3)", fontSize: "9px", letterSpacing: "4px", fontFamily: "monospace" }}>DATE</p>
                        <p style={{ margin: 0, color: "#22D3EE", fontSize: "24px", letterSpacing: "2px" }}>{date}</p>
                    </div>
                    <div style={{ textAlign: "center" }}>
                        <p style={{ margin: "0 0 2px", color: "rgba(255,255,255,0.3)", fontSize: "9px", letterSpacing: "4px", fontFamily: "monospace" }}>VENUE</p>
                        <p style={{ margin: 0, color: "rgba(255,255,255,0.7)", fontSize: "15px", letterSpacing: "2px" }}>{venue}</p>
                    </div>
                    <div style={{ textAlign: "right" }}>
                        <p style={{ margin: "0 0 2px", color: "rgba(255,255,255,0.3)", fontSize: "9px", letterSpacing: "4px", fontFamily: "monospace" }}>SERIAL</p>
                        <p style={{ margin: 0, color: "rgba(255,255,255,0.4)", fontSize: "12px", letterSpacing: "3px", fontFamily: "monospace" }}>{serial}</p>
                    </div>
                </div>
            </div>
            ...
            <div style={{ width: "228px", flexShrink: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between", padding: "28px 18px", position: "relative", zIndex: 2, backgroundColor: "rgba(34,211,238,0.03)" }}>
                <div style={{ textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", gap: "8px" }}>
                    ...
                    <div>
                        <p style={{ margin: "0 0 2px", color: "#22D3EE", fontSize: "10px", letterSpacing: "5px", fontFamily: "monospace", fontWeight: 700 }}>RASRANG</p>
                        <p style={{ margin: 0, color: "rgba(255,255,255,0.25)", fontSize: "8px", letterSpacing: "3px", fontFamily: "monospace" }}>ENTRY PASS</p>
                    </div>
                </div>
                
                {/* HIGH RESOLUTION FIX
                    We render the QR canvas at 400px (very crisp), 
                    but constrain its display container to 120px 
                */}
                <div style={{ 
                    width: "120px", 
                    height: "120px", 
                    ...
                    <QRCodeCanvas 
                        ...
                        size={400}  // High res render
                        level="H" 
                        imageSettings={{ src: "/Assets/SRM_Logo.jpeg", height: 80, width: 80, excavate: true }}
                        style={{ width: "100%", height: "100%" }} // CSS scale down
                    />
                </div>

                <div style={{ textAlign: "center" }}>
                    <p style={{ margin: "0 0 6px", color: "#FFFFFF", fontSize: "12px", letterSpacing: "5px", fontFamily: "monospace", fontWeight: 700 }}>SCAN TO ENTER</p>
    ...
    return (
        ...
        >
            ...
            <div style={{ width: "58px", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, position: "relative", zIndex: 2 }}>
                <span style={{ transform: "rotate(-90deg)", whiteSpace: "nowrap", color: "#C9A84C", fontSize: "9px", fontFamily: "monospace", fontWeight: 700, letterSpacing: "5px", opacity: 0.75 }}>
            ...
            <div style={{ flex: 1, padding: "26px 44px 22px", display: "flex", flexDirection: "column", justifyContent: "space-between", position: "relative", zIndex: 2 }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
                        ...
                        <div>
                            <p style={{ margin: 0, color: "#C9A84C", fontSize: "13px", letterSpacing: "7px", fontFamily: "monospace", fontWeight: 700 }}>
                                RASRANG 2K26
                            </p>
                            <p style={{ margin: "3px 0 0", color: "rgba(201,168,76,0.6)", fontSize: "9px", letterSpacing: "4px", fontFamily: "monospace" }}>
                                ANNUAL CULTURAL FESTIVAL
                            </p>
                        </div>
                    </div>
                    <div style={{ border: "1px solid rgba(201,168,76,0.5)", padding: "5px 16px", color: "#C9A84C", fontSize: "10px", letterSpacing: "3px", fontFamily: "monospace" }}>
                        ★ MASTER EVENT PASS ★
                    </div>
                </div>
                ...
                <div style={{ textAlign: "center" }}>
                    <p style={{ margin: "0 0 6px", color: "rgba(201,168,76,0.45)", fontSize: "10px", letterSpacing: "8px", fontFamily: "monospace" }}>ALL-ACCESS CULTURAL PASS</p>
                    <h1 style={{
                        margin: 0,
                        color: "#C9A84C",
                    ...
                    <p style={{ margin: 0, color: "rgba(255,255,255,0.45)", fontSize: "12px", letterSpacing: "3px", fontFamily: "monospace" }}>
                        {user?.regNo || "—"} &nbsp;·&nbsp; {user?.clgName || "SRM TRICHY"}
                    </p>
                </div>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", borderTop: "1px solid rgba(201,168,76,0.15)", paddingTop: "14px" }}>
                    <div>
                        <p style={{ margin: "0 0 2px", color: "rgba(201,168,76,0.4)", fontSize: "9px", letterSpacing: "4px", fontFamily: "monospace" }}>VALID DATE</p>
                        <p style={{ margin: 0, color: "#C9A84C", fontSize: "24px", letterSpacing: "2px" }}>{date}</p>
                    </div>
                    <div style={{ textAlign: "center" }}>
                        <p style={{ margin: "0 0 2px", color: "rgba(201,168,76,0.4)", fontSize: "9px", letterSpacing: "4px", fontFamily: "monospace" }}>ACCESS</p>
                        <p style={{ margin: 0, color: "rgba(255,255,255,0.65)", fontSize: "14px", letterSpacing: "2px" }}>ALL EVENTS · FULL DAY</p>
                    </div>
                    <div style={{ textAlign: "right" }}>
                        <p style={{ margin: "0 0 2px", color: "rgba(201,168,76,0.4)", fontSize: "9px", letterSpacing: "4px", fontFamily: "monospace" }}>SERIAL</p>
                        <p style={{ margin: 0, color: "rgba(255,255,255,0.35)", fontSize: "12px", letterSpacing: "3px", fontFamily: "monospace" }}>{serial}</p>
                    </div>
                </div>
            </div>
            ...
            <div style={{ width: "208px", flexShrink: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between", padding: "26px 16px", position: "relative", zIndex: 2, backgroundColor: "rgba(201,168,76,0.03)" }}>
                ...
                <div style={{ textAlign: "center" }}>
                    <p style={{ margin: "0 0 6px", color: "#C9A84C", fontSize: "11px", letterSpacing: "4px", fontFamily: "monospace", fontWeight: 700 }}>SCAN TO ENTER</p>
