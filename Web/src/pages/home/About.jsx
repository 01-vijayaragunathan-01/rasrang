                        ...
                        {activeAnnouncements.map((announcement, index) => (
                            ...
                            >
                                ...
                                <div className="relative h-full bg-[#05000a]/95 backdrop-blur-3xl rounded-[1.9rem] p-8 md:p-12 flex flex-col items-center text-center overflow-hidden">
                                    ...
                                    {/* Live Indicator - Unified Responsive Layout */}
                                    <div className="relative mb-8 flex items-center gap-2 px-4 py-2 rounded-full bg-red-500/10 border border-red-500/30 shadow-[0_0_15px_rgba(239,68,68,0.2)] z-20">
